                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <input type="date" name="sal_date" class="form-control required"
                                id="sal_date" value="<?php echo $sys_date;?>" readonly />
                                </div>
                                <div class="col-6">
                                <label for="exampleInputName1">Category:</label>
                                <select type="text" class="form-control required" name="category"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <input type="hidden" class="form-control" name="month" id="month" 
                                    value="" readonly/>
                                <input type="text" class="form-control" name="monthn" id="monthn" 
                                    value="" readonly/>
